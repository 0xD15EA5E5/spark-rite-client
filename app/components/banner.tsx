...
export function Banner({
    ...
    return (
        <div className={"relative w-full h-60 border-b-4 border-yellow-400 overflow-hidden "+(className ? className : "")}>
            <h1 className="z-51 text-neutral-50 absolute top-1/2 px-20 text-5xl -translate-y-1/2">{text}</h1>
